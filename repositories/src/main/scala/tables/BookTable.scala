...
class BookTable(tag: Tag) extends Table[Book](tag, "book") with BaseTable[Book]{
  val id = column[Int]("bk_id", O.PrimaryKey)
  val title = column[String]("bk_title")
  val lang = column[String]("bk_lang")
  val description = column[String]("bk_description")
  val ref = column[String]("bk_ref")
  val stars = column[Double]("bk_stars")
  val numOfRating = column[Int]("bk_num_o_rating")
